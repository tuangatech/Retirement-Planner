...
This project deals with people's retirement money. Contributors and users will share numbers,
assumptions, and plans that are personal and sometimes anxiety-inducing.

* **Never mock or judge someone's financial situation**, savings rate, or plan.
* **Don't give individualized financial advice** in issues or discussions. This tool is
  educational; steer people toward qualified professionals for their own decisions.
* **Don't ask anyone to share real balances.** If you need a reproduction case, ask for
  synthetic or rounded numbers.
...
maintainers by **opening a private report from the repository's Security tab** ("Report a
vulnerability" also routes private reports to maintainers), or by direct message to
[@tuangatech](https://github.com/tuangatech) on GitHub.
